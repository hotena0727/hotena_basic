...
st.set_page_config(page_title="단어 훈련", layout="centered")
apply_ui_theme()

colL, colC, colR = st.columns([1.1,2.2,1.1], vertical_alignment="center")
with colL:
    if st.button("← 홈", key="back_home_단어_훈련"):
        ...
        st.rerun()
with colC:
    st.markdown("<div style='text-align:center;font-weight:900;'>단어 훈련</div>", unsafe_allow_html=True)
with colR:
