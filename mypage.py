...
/* ============================================================
   ✅ V4.9.16 FINAL: 메시지 목록 "카드형 + 촘촘하게"
   - (원하는 캡처처럼) 목록 박스 간격을 거의 붙게
   - summary를 '라운드 카드'로 만들고, 펼치면 아래 컨텐츠가 이어지게
   - 기존 타임라인 라인/점(요소) 제거
   ============================================================ */
...
.ha-msg-scope div[data-testid="stExpander"] + div[data-testid="stExpander"]{
  margin-top: 4px !important;  /* ✅ 더 붙이려면 2px / 완전 붙이면 0px */
}
...
/* 기존 타임라인 라인/점 제거(혹시 상위 규칙이 먹으면 무효화) */
