...
from ui_components import render_top_menu, go
...
def go(page: str):
    ...
    st.session_state["hub_page"] = view_map.get(page, "홈")
...
def render_top_tabs():
    ...
    plan = _plan_label()
    current = st.session_state["hub_page"]
