...
def ask_hatena(
    *,
    ...
    user_input: str,
    context: str = "",
    meta: dict | None = None,  # optional extra info (safe to ignore)
    min_lines: int = MIN_LINES_DEFAULT,
    max_lines: int = MAX_LINES_DEFAULT,
    **kwargs,  # forward-compat: ignore unexpected params
) -> str:
    """
    Main entry:
    ...
    """
    # accept extra params without raising; keep cost unchanged unless you use them
    _ = meta; _ = kwargs
