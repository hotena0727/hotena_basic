...
def hotena_title(icon_path: str, title: str, size_px: int = 56, gap_px: int = 0, right_text: str | None = None):
    ...
    right_html = f'<div style="margin-left:auto;font-size:0.98rem;opacity:0.85;transform:translateY(4px);">{right_text}</div>' if right_text else ""
    st.markdown(
        f"""
        <div style="display:flex;align-items:flex-end;gap:{gap_px}px;margin:4px 0 10px 0;">
          ...
          <div style="font-size:1.18rem;font-weight:900;line-height:1.05;white-space:nowrap;transform:translateY(4px);">
            {title}
          </div>
          {right_html}
        </div>
